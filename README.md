...
I then tested an alternative pair of units $u_{a,1}, u_{r,1}$, which produced an estimated vector $\mathbf{\hat{F}_1}$. The distance between $F_{.}$ and $\hat{F}_{.,1,1}$ was evaluated using the **F1 score**, denoted $F1_{1,1}$.
